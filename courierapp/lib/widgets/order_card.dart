...
import 'package:courierapp/mainScreens/order_details_screen.dart';
import 'package:courierapp/models/items.dart';
...
class OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        decoration: const BoxDecoration(color: Color.fromARGB(255, 64, 64, 64)),
